...
function Navbar() {
 ...
 useEffect(() => {
  ...
  return (
    <>
   <div
  className={`navbar px-5 sticky top-0 z-50 transition-all duration-300
...
>
        ...
        <div className="navbar-end gap-3">
          ...
          <input
            type="text"
            placeholder="Search"
            className="input input-bordered bg-white text-black placeholder:text-gray-500 rounded-full w-24 md:w-auto focus:outline-none focus:ring-2 focus:ring-pink-500"
          />
  ...
  >
    ...
    >
      ...
      />
          ...
          {/* Login Button */}
        <button
  className="btn btn-primary rounded-full px-6 text-white hover:scale-105 transition duration-300 shadow-lg"
